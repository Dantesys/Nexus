...
public class InfusorMenu extends AbstractContainerMenu {
    public final InfusorEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public InfusorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public InfusorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuType.INFUSOR_MENU.get(), pContainerId);
        this.blockEntity = ((InfusorEntity) entity);
