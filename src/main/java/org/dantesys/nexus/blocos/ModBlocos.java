...
public class ModBlocos {
    ...
    public static final DeferredBlock<Coletor> COLETOR = BLOCOS.registerBlock("coletor",(properties ->  new Coletor(properties.strength(2,10).dynamicShape().noOcclusion())));
